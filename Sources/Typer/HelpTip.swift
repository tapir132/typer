...
enum QuickHelp {
    ...
    static let liveCaptureGaps = "Use Live capture during active writing, not an hour of general browsing. Long gaps don't affect key timing, but lower measured speed; gaps up to a minute can be learned as pauses."
    ...
    static let inputMonitoring = "Only needed for Live capture. Recording starts when you choose Start live capture, and stops manually or after 15 minutes."
